            ...
            <ul class="sidebar-menu">
			  ...
			  <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="input_anggota.php"><i class="fa fa-angle-right"></i> Input Anggota</a></li>
                  <li><a href="input_barang.php"><i class="fa fa-angle-right"></i> Input Barang</a></li>
				  <li><a href="input_kategori.php"><i class="fa fa-angle-right"></i> Input Kategori</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="charts.html">
