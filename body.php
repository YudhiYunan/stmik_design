<div class="col_3">
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-sitemap user1 icon-rounded"></i>
                    <div class="stats">
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-tasks user2 icon-rounded"></i>
                    <div class="stats">
        	...
        	<div class="col-md-3 widget">
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-tags dollar2 icon-rounded"></i>
                    <div class="stats">
                      <h5><strong></strong></h5>
                      <span></span>
                    </div>
